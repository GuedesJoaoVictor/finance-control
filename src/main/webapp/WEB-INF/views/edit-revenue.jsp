...
<form id="expenseForm">
    ...
    <input id="date" name="date" type="date" value="${revenue.receipt_date}" required>
    ...
    <input type="text" name="description" id="description" value="${revenue.description}" required>
